...
import { fetchSuccessOrders,fetchSuccessfulOrderPdf } from '../../redux/actions/reports/reportActions';
...
class SuccessfulOrders extends PureComponent {
    ...
    onFilterDate = () => {
        this.props.fetchSuccessOrders(this.state).then(function (response) {
            console.log("=-=-)))",response)
...
export default connect(
    mapStateToProps, { fetchSuccessOrders,fetchSuccessfulOrderPdf}
)(SuccessfulOrders);
