...
class AddMonthlyAuction extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            id: this.props.MonthlyAuctionInfo.id,
            auctionTypeId: 5,
            showId: this.props.MonthlyAuctionInfo.show.id,
            channelId: this.props.MonthlyAuctionInfo.episode.channelId,
            episodeId: this.props.MonthlyAuctionInfo.episodeId,
            location: this.props.MonthlyAuctionInfo.location,
            showName: this.props.MonthlyAuctionInfo.show.showName,
            auctionCategoryName: this.props.MonthlyAuctionInfo.auctionsCategory.auctionCategoryName,
            round: "",
            auctionBidFee: this.props.MonthlyAuctionInfo.auctionBidFee,
            productId: this.props.MonthlyAuctionInfo.product.id,
            productImage: this.props.MonthlyAuctionInfo.product.productImage,
            auctionCode: this.props.MonthlyAuctionInfo.auctionCode,
            auctionCategoryId: this.props.MonthlyAuctionInfo.auctionCategoryId,
            status: true,
            auction_start_date: new Date(),
            auction_end_date: new Date(),
            auctionStartTime: new Date(this.props.MonthlyAuctionInfo.auctionStartTime),
            auctionEndTime: new Date(this.props.MonthlyAuctionInfo.auctionEndTime),
            displayStartDateTime: new Date(this.props.MonthlyAuctionInfo.displayStartDateTime),
            displayOrder: this.props.MonthlyAuctionInfo.order,
            updatedStartDate: '',
            updatedEndDate: '',
            ImgPath: ''
        }
    ...
    handleSubmit = evt => {
        ...
        singleobj.auctionStartTime = this.state.auctionStartTime;
        singleobj.auctionEndTime = this.state.auctionEndTime;
                                ...
                                <Row>
                                    ...
                                    <Col sm="6" className="text-right">
                                        <div className="form-group">
                                            <Select
                                                options={prs}
                                                placeholder={this.props.MonthlyAuctionInfo.product.productName}
                                        ...
                                        <div class="upload_box">
                                            ...
                                            {this.state.ImgPath ? (
                                                <div className="uploaded_img">
                                                    ...
                                                    <img src={this.props.MonthlyAuctionInfo.product.productImage} width='100px' />
                                                </div>}
                                        </div>
                                    </Col>
                                </Row> */}
